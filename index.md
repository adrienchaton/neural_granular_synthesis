...
_ trained on the Drum dataset: <audio controls><source src="audio/drum_samples.wav"></audio>

_ trained on the Methlab sample pack: <audio controls><source src="audio/methlab_sample.wav"></audio>

_ trained on the SOL dataset (instruments of the orchestra playing *ordinario*): <audio controls><source src="audio/ordinario_samples.wav"></audio>
